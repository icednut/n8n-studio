...
4단계 설계를 담당한다. `docs/yyyyMMdd-기능요약/01-spec.md`를 읽고 설계 문서와 통합 테스트 시나리오를 산출한다.
...
설계 문서 저장 경로: `docs/yyyyMMdd-기능요약/02-design.md`
...
- 단위 테스트 시나리오 (`workflow/[프로젝트명]/test/unit/`)
- 통합/인수 테스트 시나리오 (`workflow/[프로젝트명]/test/acceptance/`)

테스트 시나리오 파일: `docs/yyyyMMdd-기능요약/03-test-plan.md` (계획 문서)
실제 테스트 코드: `workflow/[프로젝트명]/test/unit/`, `workflow/[프로젝트명]/test/acceptance/`
